...
export class DeviceProducerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.deviceProducerService
      ...
      .subscribe(
        (res: HttpResponse<IDeviceProducer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDeviceProducers(): void {
    this.eventSubscriber = this.eventManager.subscribe('deviceProducerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDeviceProducer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/device-producer'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
