...
export class DeviceTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.deviceTypeService
      ...
      .subscribe(
        (res: HttpResponse<IDeviceType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDeviceTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('deviceTypeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDeviceType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
